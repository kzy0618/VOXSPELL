...
import SpellingAidWindow.SpellingAid;
...
public class VideoPlayer extends JFrame implements ActionListener, WindowListener {
	...
	private static String additionalPath = currentWorkingDirectory;
	private EmbeddedMediaPlayerComponent mediaPlayerComponent;
	private File bunny = new File(currentWorkingDirectory+"/Image/big_buck_bunny_1_minute.avi");
	private File bunny_negative = new File(currentWorkingDirectory+"/Image/big_buck_bunny_1_minute_converted.avi");
	private File video;
	...
	public VideoPlayer(SpellingAid MainMenu,JFrame which){
		super("VideoPlayer");
		this.which=which;
	...
	public void actionPerformed(ActionEvent e) {
		...
		String path = currentWorkingDirectory+"/src";
		System.out.println(path);

		NativeLibrary.addSearchPath(RuntimeUtil.getLibVlcLibraryName(), "/usr/lib"+":"+path+":"+path+"/Image"
				+additionalPath);
